...
- 2026-09-09: El usuario pidió además ver la ropa completa (no solo las caras) y mejorar calidad/velocidad de carga — con `object-cover` siempre se pierde algo (cara o ropa) en un video vertical dentro de una franja horizontal, así que se pasó a `object-contain` + optimización del archivo — ver tarea 088 para el detalle completo.

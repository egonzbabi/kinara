...
- [x] El costo de envío ($150 MXN) usado en el cobro de Stripe es un **placeholder explícito** (`app/lib/shipping.ts`, comentado `TODO`) pendiente de que el usuario integre Skydropx para cotizar en tiempo real — ninguna tarea futura debe tratarlo como definitivo ni "limpiarlo" sin confirmar con el usuario primero.
